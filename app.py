...
# Load dataset
data = pd.read_csv(r'D:\Health care\health_analysis_prediction_app-master\data\healthcare_dataset (1).csv')
...
def health_prediction(user_name, age, gender, bmi, blood_pressure, cholesterol, glucose_level, family_history, existing_conditions):
    ...
    # Helper: convert matplotlib figure to inline base64 image for Markdown
    def fig_to_base64(fig):
        ...
        plt.close(fig)
        return f"![Prediction Probability Pie Chart](data:image/png;base64,{encoded})"
    ...
    if prediction[0] == 'Yes':
        ...
        # Embed pie chart inline in Markdown
        fig, ax = plt.subplots()
...
iface = gr.Interface(
    ...
    description="Welcome to the Health Prediction App! Enter your details below to get predictions. -created by  SHARVESH RAM :)❤️ ",
)
# Launch Gradio UI
iface.launch()
